...
export default function BuyerDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const ordersRes = await api.get('/orders?type=buying&limit=5');
      ...
      const totalSpent = ordersRes.data.orders?.filter(order => 
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{stats.totalSpent} KES</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow">
        <div className="p-6 border-b border-gray-200">
          <div className="flex justify-between items-center">
            ...
            <Link to="/orders?type=buying" className="text-green-600 hover:text-green-700 text-sm font-medium">
              View All
            </Link>
          </div>
        </div>
